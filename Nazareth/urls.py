...
urlpatterns = [
    ...
    path('get_queue_position/', views.get_queue_position, name='get_queue_position'),
    ...
    path('api/doctor/appointments/', views.doctor_appointments_api, name='doctor_appointments_api'),
